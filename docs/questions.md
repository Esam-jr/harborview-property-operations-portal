...
**Solution:** Built a deterministic mechanism (often using a hash of the staff user's ID against the configuration version) to ensure consistent assignment to the 10% group for a given homepage configuration rollout.
